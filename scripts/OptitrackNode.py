...
class OptitrackNode():
    ...
    def __init__(self):
        # Create a publisher
        pub_p = rospy.Publisher('MyUAV/cpose', CustomPose, queue_size=1)
        ...
        # Create subscribers
        rospy.Subscriber("MyUAV/pose", PoseStamped, self.adjust_axis, queue_size=1)
